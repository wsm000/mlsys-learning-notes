...
上一篇：[diy_llm_task3_architecture_and_hyperparameters_learning_notes.md](diy_llm_task3_architecture_and_hyperparameters_learning_notes.md)——对应 CS336 第 3 讲与 DIY-LLM 第 4 章：标准 Transformer 五大件、Pre-Norm/RMSNorm/SwiGLU/RoPE 四大改造、MHA→MQA→GQA→MLA 压 KV 主线、超参数经验法则与训练稳定性三板斧，含自测清单与速查表。
